...
Page({
	data: {
		...
		seasonalKnowledge: {
			1: { // 一月 - 冬季
				title: '冬季皮肤干燥护理',
				summary: '冬季空气干燥，宠物容易出现皮肤干燥、脱屑等问题。注意保湿护理，使用温和的洗护产品，适当增加室内湿度。',
				keywords: ['冬季护理', '皮肤干燥', '保湿', '温和洗护']
			},
			2: { // 二月 - 冬末春初
				title: '换季过敏预防',
				summary: '冬春交替季节，宠物容易发生过敏反应。注意观察皮肤变化，及时调整饮食和环境，预防季节性过敏。',
				keywords: ['换季过敏', '过敏预防', '皮肤观察', '环境调整']
			},
			3: { // 三月 - 春季
				title: '春季寄生虫防治',
				summary: '春季是寄生虫活跃期，需要加强体外驱虫。定期检查宠物皮肤，发现跳蚤、蜱虫等及时处理。',
				keywords: ['春季驱虫', '寄生虫防治', '跳蚤', '蜱虫']
			},
			4: { // 四月 - 春季
				title: '花粉过敏防护',
				summary: '春季花粉增多，容易引起宠物过敏。减少外出时间，回家后及时清洁，保持室内空气清新。',
				keywords: ['花粉过敏', '过敏防护', '清洁护理', '室内环境']
			},
			5: { // 五月 - 春末夏初
				title: '夏季前皮肤准备',
				summary: '为即将到来的夏季做准备，调整洗护频率，选择清爽型产品，预防夏季常见的皮肤问题。',
				keywords: ['夏季准备', '清爽护理', '洗护调整', '皮肤准备']
			},
			6: { // 六月 - 夏季
				title: '夏季湿热环境护理',
				summary: '夏季高温高湿，宠物容易患皮肤病。保持皮肤干燥，增加洗澡频率，注意通风和降温。',
				keywords: ['夏季护理', '湿热环境', '皮肤干燥', '通风降温']
			},
			7: { // 七月 - 夏季
				title: '热疹和湿疹防治',
				summary: '夏季常见热疹和湿疹问题。避免长时间暴露在高温环境，及时清洁皮肤褶皱，保持干燥。',
				keywords: ['热疹防治', '湿疹护理', '高温防护', '皮肤清洁']
			},
			8: { // 八月 - 夏季
				title: '紫外线防护',
				summary: '夏季紫外线强烈，宠物皮肤也需要防晒。避免正午外出，选择有遮阳的散步时间，必要时使用宠物防晒产品。',
				keywords: ['紫外线防护', '防晒护理', '遮阳', '外出时间']
			},
			9: { // 九月 - 夏末秋初
				title: '秋季换毛期护理',
				summary: '秋季是换毛期，需要加强梳理，预防毛球和皮肤问题。适当增加营养，帮助新毛生长。',
				keywords: ['秋季换毛', '梳理护理', '毛球预防', '营养补充']
			},
			10: { // 十月 - 秋季
				title: '秋季过敏与皮肤敏感',
				summary: '秋季过敏高发期，宠物容易出现皮肤瘙痒、红肿等问题。注意环境清洁，使用温和的洗护产品。',
				keywords: ['秋季过敏', '皮肤敏感', '瘙痒护理', '温和洗护']
			},
			11: { // 十一月 - 深秋
				title: '深秋皮肤保湿',
				summary: '深秋天气干燥，需要加强皮肤保湿护理。选择保湿型洗护产品，适当补充必需脂肪酸。',
				keywords: ['深秋保湿', '皮肤护理', '保湿产品', '必需脂肪酸']
			},
			12: { // 十二月 - 冬季
				title: '冬季皮肤健康维护',
				summary: '冬季需要特别关注皮肤健康，注意保暖的同时保持皮肤清洁，预防冬季常见的皮肤问题。',
